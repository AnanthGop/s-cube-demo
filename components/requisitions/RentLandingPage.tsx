...
interface RentLandingPageProps {
  data: RentEntry[];
  onOpenSummary: () => void;
  onOpenRenewals: () => void;
  onOpenVouchers: () => void;
...
export const RentLandingPage: React.FC<RentLandingPageProps> = ({
  data,
  onOpenSummary,
  onOpenRenewals,
  onOpenVouchers,
  ...
  const cardStats = useMemo(() => {
    ...
    // Calculate renewals based on endDate within next 2 months
    ...
    const vouchers = data.filter((entry) => entry.activeForJV === "Y").length;
      ...
      <div
        ...
        <div className="p-8 md:p-10">
          ...
          <p
            ...
            Choose a rent workflow to continue. Counts reflect current records.
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <button
              ...
              <h2 className="mt-5 text-lg font-black tracking-tight">
                Rent Master ({cardStats.total})
              </h2>
              <p
                className={`mt-2 text-xs ${
                  isDarkMode ? "text-slate-300" : "text-slate-600"
                }`}>
                Open the full rent management page.
              </p>
            </button>
            ...
            <button
              ...
              <h2 className="mt-5 text-lg font-black tracking-tight">
                Rent Vouchers ({cardStats.vouchers})
              </h2>
              <p
                className={`mt-2 text-xs ${
                  isDarkMode ? "text-slate-300" : "text-slate-600"
            ...
            <button
              ...
              <p
                ...
                Map rent agreements to chart of accounts for posting.
              </p>
            </button>
          </div>
        </div>
